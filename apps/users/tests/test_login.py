...
class LoginTests(TestCase):
    ...
    def _login(self, **overrides):
        ...
        return self.client.post(reverse('users:login'), data=json.dumps(payload), content_type='application/json')
...
class RefreshTests(TestCase):
    ...
    def test_refresh_works_with_expired_access_cookie(self):
        ...
        resp = self.client.post(reverse('users:token_refresh'), content_type='application/json')
        self.assertEqual(resp.status_code, 200)
